...
export const defaultSettings = {
  ...
  ourStory: "Founded with a pioneering spirit, the Pakistan Islamic International School System (PIISS) embarked on a mission to redefine education with Quranic ethics and FBISE distinction merit.",
  logoUrl: "",
